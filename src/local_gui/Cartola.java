...
public class Cartola extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cartola");
        setBackground(new java.awt.Color(32, 39, 55));
        ...
        jLabel2.setText("CARTOLA CLIENTE");
    ...
    Object vector[]=new Object[8];
        ...
        {
            vector[0]= this.jTable1.getValueAt(i,0);
            vector[1]= this.jTable1.getValueAt(i,1);
            
            if (this.jTable1.getValueAt(i,2).equals("DEPOSITO")){
                vector[2]= this.jTable1.getValueAt(i,3);
                vector[3]= "";
            }
            
            if (this.jTable1.getValueAt(i,2).equals("GIRO")){
                vector[2]= "";
                vector[3]= "-" + this.jTable1.getValueAt(i,3);
            }
            vector[4]= this.jTable1.getValueAt(i,4);
            vector[5]= this.jTable1.getValueAt(i,5);
            vector[6]= this.jTable1.getValueAt(i,6);
            dtm.addRow(vector);
        }
